                ...
                if form.is_valid():
                    ...
                    try:
                        ...
                        if followed_user == user_obj:
                            messages.error(request, f"Erreur: vous ne pouvez pas vous suivre vous-même, merci d'essayer à nouveau!")
                            ...
                            new_follow.save()
                            messages.success(request, f"Vous suivez maintenant l'utilisateur {new_follow.followed_user}.")
                            return redirect("follow")
